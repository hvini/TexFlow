...
export default function DashboardPage() {
    ...
    const handleUpgrade = async () => {
        ...
        try {
            ...
            // Optimistic update
            setUserData(prev => ({ ...prev, tier: 'premium', subscriptionEnd: nextMonth }));
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    {userData.tier === 'free' && (
                                        <button
                                            ...
                                            className="px-3 py-1 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-white text-xs font-bold uppercase tracking-wider rounded shadow-lg transition-all"
                                        >
                                            Upgrade
                                        </button>
                                    )}
